...
//---> version of randomize setTimeout or $timeout between 1 - 10 second Start Here//
//---> version of randomize setTimeout or $timeout between 1 - 10 second Start Here//
    ...
    function randomAllComments() {
         ...
         var randomNames = Math.floor(Math.random() * namesArr.length); 
          var randomElement = namesArr[randomNames];
         var randomcomments = Math.floor(Math.random() * chatArr.length); 
          var randomElement2 = chatArr[randomcomments];
         var randomImages = Math.floor(Math.random() * imagesArr.length); 
          var randomElement3 = imagesArr[randomImages];
    ...
    //---> version of randomize setTimeout or $timeout End Here//
    //---> version of randomize setTimeout or $timeout End Here//
